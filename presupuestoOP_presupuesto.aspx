        ...
        <div id="page-wrapper">
            ...
            <div id="panelMantenimiento" style="display: none">
                <div class="data-body shadow">
                    <fieldset class="p0" style="border: none !important">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <fieldset class="mt-10 mb10 text-center">
                                <legend class="mb-5">Descripci&oacute;n / objeto del gasto</legend>
                                <input type="text" class="ui descripcionTb" value="Sueldos fijos (2.1.1.1.01)" readonly />
                            </fieldset>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="ui cbo" disabled>
                                    <option selected>0002 - ORNATO Y SANEAMIENTO DE CALLES, PAZAS Y PARQUES</option>
                                    <option>Gastos ordinarios</option>
                                    <option>Compensaci&oacuten por horas extras</option>
                                </select>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label>Destino del gasto / Cta. banco</label>
                                <select class="ui cbo">
                                    <option selected>11 - GASTOS DE PERSONAL 25% (1.P)</option>
                                    <option>Gastos ordinarios</option>
                                    <option>Compensaci&oacuten por horas extras</option>
                                </select>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>Funci&oacuten</label>
                                <select class="ui cbo">
                                    <option selected>3201 - Proteci&oacute de la biodiversidad y el paisaje</option>
    ...
    <div class="dv-btn-acciones alert">
        <div class="botones">
            ...
            <div class="acciones nuevo" style="display: none">
                ...
                <div class="dropup">
                    <button class="boton boton-imprimir dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Agregar Partida <span class="caret"></span>
                    </button>
