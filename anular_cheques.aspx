    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <nav class="topbar">
                ...
                <div class="h-opcion">
                    <h4 class="opcion-menu">Anular cheques físicos</h4>
                </div>
            </nav>
            <!-- // Data body //////// //////-->
...
<div class="dv-btn-acciones alert">
            <div class="botones">
                ...
                <div class="acciones" style="display: none">
                    ...
                    <button class="boton boton-anular">AnularReversar Cheques</button>
                    <button class="boton boton-cancelar">Anular Cheque Físico</button>
                    <button class="boton boton-aprobar">Re-Autorizar</button>
                </div> 
            </div>
        </div>
